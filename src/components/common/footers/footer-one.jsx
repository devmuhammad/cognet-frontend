                                ...
                                <div className="col-lg-6">
                                    <div className="subscribe">
                                        <div>
                                            ...
                                            <p>Never Miss Anything From Cognet By Signing Up To Our Newsletter. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                        ...
                        <div className="row footer-theme partition-f">
                            <div className="col-lg-4 col-md-6">
                                ...
                                <div className="footer-contant">
                                    ...
                                    <p>Purchase your construction materials online at your own comfort and 
                                        get delivery at your construction site nationwide at affordable cost.</p>
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-md-6 col-sm-12">
                                <div className="footer-end">
                                    <p><i className="fa fa-copyright" aria-hidden="true"></i> 2020-21 Cognet
                                        powered by cubicle-ng</p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-md-6 col-sm-12">
